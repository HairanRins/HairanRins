...
--->
[![My Skills](https://skillicons.dev/icons?i=c,go,rust,py,cs,godot,js,ts,dart,flutter,react,tailwind,nodejs,express,nextjs,nestjs,flask,django,php,laravel,mysql,mongodb,pytorch,tensorflow,linux,git,docker,postman,figma,bash,&perline=10)](https://skillicons.dev)
